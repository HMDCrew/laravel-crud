...
<x-app-layout>
    <div class="card mt-4">
        <div class="card-header p-3">
          <h5 class="mb-0 text-center mt-3">Edit permice</h5>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-12 mx-auto">
                        <div class="input-group input-group-outline mb-4 is-filled">
                            ...
                            <input type="text" name="permission" id="permission" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" value="{{ old('permission', $permission->title) }}">
                        </div>
                        @error('permission')
